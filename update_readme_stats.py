    ...
    try:
        ...
        if stats_module:
            ...
            if like_li:
                ...
                if itemcount_tag:
                    stats["likes"] = itemcount_tag.text.strip()
                else:
            ...
            if download_li:
                ...
                if itemcount_tag:
                    stats["downloads"] = itemcount_tag.text.strip()
                else:
            ...
            if view_li:
                ...
                if itemcount_tag:
                    stats["views"] = itemcount_tag.text.strip()
                else:
...
if __name__ == "__main__":
    ...
    if scraped_data:
        ...
        sys.exit(0 if made_changes else 0)  # Exit with success code
    else:
